...
class CollisionEnergyConfigWithClassification:
    ...
    hierarchy: Dict[str, Union[int, str]] = field(default_factory=lambda: collision_energies)

    def extract_numeric_energy(self, energy_str: Optional[str], machine_type: Optional[str]) -> float:
    ...
    def prepare_for_embedding(self, energy_str: Optional[str], machine_type: Optional[str]) -> float:
